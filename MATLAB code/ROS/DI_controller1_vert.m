function [U1,U2,feas] = DI_controller1_vert(state_main,state_bot2, N, A0, B0, Q, R, QN, r1, r2, gamma,eta, a_lim, Bd, disturbances, target,r_roundabout,D)
%DI_CONTROLLER 
    % input: state_main - state of robot that we calculate, state_bot2 - state of the other robot, N - MPC
