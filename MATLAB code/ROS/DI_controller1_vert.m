function [U1,U2,feas] = DI_controller1_vert(state_main,state1,N, A0, B0, Q, R, QN, r1, r2, gamma,eta, a_lim, Bd, disturbances, target,r_roundabout,D)
%DI_CONTROLLER Summary of this function goes here
    ...
    for k = 1: N
        ...
        if abs(state_main(1))<0.2 && abs(state_main(2)) > r_roundabout + 0.5
